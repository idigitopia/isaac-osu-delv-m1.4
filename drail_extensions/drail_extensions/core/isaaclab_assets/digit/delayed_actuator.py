...
class DelayedPDActuator(ImplicitActuator):
    """Implicit PD actuator with delayed command application.

    This class extends the :class:`ImplicitPDActuator` class by adding a delay to the actuator commands. The delay
...
@configclass
class DelayedPDActuatorCfg(ImplicitActuatorCfg):
