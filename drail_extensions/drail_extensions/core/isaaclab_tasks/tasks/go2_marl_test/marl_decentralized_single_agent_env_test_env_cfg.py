...
@configclass
class Go2_MARL_Decentralized_Single_Agent_Test_EnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class Go2_MARL_Decentralized_Single_Agent_Test_EnvCfg_PLAY(Go2_MARL_Decentralized_Single_Agent_Test_EnvCfg):
    def __post_init__(self):
        super().__post_init__()
